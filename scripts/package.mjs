// Builds the extension and zips dist/ into site/jumpkey.zip for the download page.
// The zip unpacks to a single `jumpkey/` folder. Also stamps the current version
// into site/index.html (elements with data-version).
